    ...
    return(
        <div className="grid gap-3 w-main max-w-main mx-auto py-8">
            <div className="grid grid-cols-3 gap-3">
                <div className="flex flex-col rounded-lg p-4 pb-0 pr-0 border-[1px] border-tertiary h-[242px]">
                    ...
                    {firstTrack && tracks?.length ? (
                        ...
                        <span className="text-sm text-secondary">
                            This artist has not published any songs.
                        </span>
                    )}
                </div>
                <div className="flex flex-col rounded-lg p-4 pb-0 pr-0 border-[1px] border-tertiary h-[242px]">
                ...
                <div className="flex flex-col rounded-lg p-4 pb-0 pr-0 border-[1px] border-tertiary h-[242px]">
                    <span className="block text-xs text-secondary mb-3">
                        {artist?.name} can also {featured?.length ? 'be' : 'NOT be'} found here...
                    </span>
                    <div className="flex-1 scrollbar overflow-y-scroll pr-2 pb-4">
                        {firstFeatured && featured?.length ? (
                            <>
                            <div className="flex gap-3">
                                <Image 
                                    className="w-16 aspect-square rounded object-cover"
                            ...
                            <span className="text-sm text-secondary">
                                This artist does not have enough data to show any featured content, or they are just not featured anywhere.
                            </span>
                        )}
                    </div>
                </div>
            ...
            <div className="rounded-lg border-[1px] border-tertiary p-4">
                ...
                {related!?.length ? (
                    ...
                    <span className="text-sm text-secondary">
                        This artist does not have enough data to show related artists.
                    </span>
                )}
            </div>
        </div>
