...
export const Tooltip: React.FC<{
    ...
    return(
        <motion.div 
            className="[--tooltip-bg:#0c0e02] [--tooltip-offset:0px] fixed z-20 p-3 bg-[var(--tooltip-bg)] rounded-lg pointer-events-none text-xs font-medium max-w-[240px] after:border-[7px] after:border-transparent after:absolute data-[position=top]:after:border-t-[var(--tooltip-bg)] data-[position=top]:after:top-full data-[position=top]:after:left-[calc(50%+var(--tooltip-offset))] data-[position=top]:after:-translate-x-2/4 data-[position=bottom]:after:border-b-[var(--tooltip-bg)] data-[position=bottom]:after:bottom-full data-[position=bottom]:after:left-[calc(50%+var(--tooltip-offset))] data-[position=bottom]:after:-translate-x-2/4"
            initial={{ 
                opacity: 0, 
                scale: INITIAL_SCALE,
            }}
