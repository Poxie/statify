            ...
            <div className="w-full h-full z-40 fixed top-0 left-0 pointer-events-none">
                ...
                <AnimatePresence mode="wait">
                    {activeModal && (
                        <motion.div
                            key={activeModal.id}
                            className="scrollbar scrollbar-light w-[500px] max-w-full max-h-[100dvh] sm:max-h-[90dvh] absolute top-2/4 left-2/4 translate-x-2/4 translate-y-2/4 bg-primary rounded-lg pointer-events-auto overflow-auto"
